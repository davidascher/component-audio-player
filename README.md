...
[![Build Status](https://travis-ci.org/mozilla-appmaker/component-audio-player.png)](https://travis-ci.org/mozilla-appmaker/component-audio-player)

An audio player component for [Appmaker](https://github.com/mozilla-appmaker/appmaker).

Appmaker import:
```
<link rel="import" href="/component-audio-player">
```

# Test Status

See the github page http://mozilla-appmaker.github.io/component-audio-player/ for test status.
...
Clone this repo:
```
git clone git@github.com:mozilla-appmaker/component-audio-player.git
```
...
Your directory structure should look like this (more component repos can be cloned as siblings of `component-audio-player`):
```
mozilla-appmaker/
  ├── appmaker/
  ├── component-audio-player/
...
Enter the `component-audio-player` directory, and install npm dependencies
```
cd component-audio-player
npm install
```
